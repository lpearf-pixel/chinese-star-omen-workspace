...
def audit_kaiyuan_corpus(fulltext_path: Path, volumes_dir: Path) -> dict[str, Any]:
    ...
    report["ok"] = not any(
        (
            report["section_count"] != report["expected_section_count"],
            report["section_heading_count"] != report["expected_section_count"],
            report["volume_file_count"] != report["expected_section_count"],
            report["duplicate_section_headings"],
            report["empty_sections"],
            report["missing_sections"],
            report["extra_sections"],
            report["missing_volume_files"],
            report["extra_volume_files"],
            report["empty_volume_files"],
            report["different_volumes"],
            report["duplicate_page_markers"],
            report["invalid_page_markers"],
            report["page_marker_volume_mismatches"],
            report["non_monotonic_page_markers"],
